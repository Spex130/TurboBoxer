...
namespace Assets.Scripts.Util
{
    ...
    public class CustomInput : MonoBehaviour
    {
        ...
        {
            Up, Down, Left, Right, Pause, Accept, Cancel, Action, Block
        }
        ...
        public static void RawSign()
        {
            ...
            rawSign[(int)UserInput.Action] = 1;
            rawSign[(int)UserInput.Block] = 1;
        }
        ...
        public static void DefaultKey()
        {
            ...
            keyboard[(int)UserInput.Action, 0] = KeyCode.K;
            keyboard[(int)UserInput.Block, 0] = KeyCode.J;
        }
        ...
        public static void DefaultPad()
        {
            ...
            gamepad[(int)UserInput.Action, 0] = A;
            gamepad[(int)UserInput.Block, 0] = B;
        }
